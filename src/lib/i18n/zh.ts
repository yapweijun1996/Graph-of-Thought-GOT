...
export const zh: Record<TranslationKey, string> = {
  ...
  'empty.title': '思维图谱',
  'empty.what':
    '带来一个问题或决策。GOT 会沿多个分支推理 —— 每条由不同的分析角色论证 —— 然后给出推荐路径和关键洞察。不同分支独立达成一致的地方，就是信号。',
  ...
  'topbar.insights': '洞察',
  'insights.title': '洞察',
  'insights.recommendedPath': '推荐路径',
  'insights.keyInsights': '关键洞察',
  'insights.convergence': '推理在哪里收敛',
  'insights.nextSteps': '建议的下一步',
  'insights.empty': '先生成并展开一个思维图，才能看到洞察。',
  'insights.generateReport': '生成完整报告',
  'insights.noKeyInsights': '暂无突出洞察 —— 多展开或评分一些节点。',
  'insights.noConvergence': '尚未检测到收敛。',
  'insights.close': '关闭',
};
